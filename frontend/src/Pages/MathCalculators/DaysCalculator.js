  ...
  const DaysCalculator = () => {
    ...
    <div className="container mt-5">
        ...
        <Typography  color="textSecondary" paragraph>
                Calculate the difference in days between two dates using the Days Calculator. Enter the dates in the DD-MM-YYYY format. 
                If the result is negative, it represents the number of days until the second date occurs in the future.
              </Typography>
        <div className="row">
