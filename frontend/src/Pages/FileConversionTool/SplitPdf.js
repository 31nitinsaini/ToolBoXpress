      ...
      <main>
        <div className="container my-5 text-center">
          ...
          <Typography variant="body1">
            Use the PDF Splitter to extract specific pages from your PDF file. Select your PDF, specify the range of pages
            to split, and preview the result before downloading the newly created PDF.
          </Typography>
