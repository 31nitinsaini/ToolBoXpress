  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Convert images to different formats with ToolboXpress Image Conversion Tool. Change image formats easily for various purposes. Fast, intuitive, and free!"
        />
        <meta
          name="keywords"
          content="Image conversion tool, convert image formats, image file converter, ToolboXpress"
        />
      ...
      <main>
        <div className="container my-5">
          ...
          <div style={{ textAlign: 'center', marginBottom: '20px' }}>
            <h1 style={{ fontSize: '2em', color: '#333' }}>Image Conversion Tool</h1>
            <p style={{ fontSize: '1.2em', color: '#555' }}>
              Convert images to different formats with ToolboXpress Image Conversion Tool.
              Change image formats easily for various purposes. Fast, intuitive, and free!
            </p>
          </div>
          ...
          <div className="row">
            <div className="col-md-6">
              ...
              {image && (
                <>
                  ...
                  <button className="btn btn-primary mt-3" onClick={convertImage}>
                    Convert Image
                  </button>
                </>
              )}
            ...
            {convertedDataUrl && (
              <div className="col-md-6 mt-4">
                ...
                <button className="btn btn-primary mt-3" onClick={downloadConvertedImage}>
